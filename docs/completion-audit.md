...
| Full build health | Fresh `pixi run check` passed Ruff, 234 Python tests, six Eve policy tests, TypeScript typecheck/build, 14 regenerated face frames, and the ESP32-S3 PlatformIO build (49.7% RAM, 36.0% flash) | Proven |
